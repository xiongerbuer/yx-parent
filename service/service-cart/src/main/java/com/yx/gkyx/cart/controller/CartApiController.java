package com.yx.gkyx.cart.controller;
...
@RestController
@Api(tags = "购物车接口")
@RequestMapping(value = "/api/cart", produces = APPLICATION_JSON_VALUE)
...
public class CartApiController {
    ...
    public Result<String> batchDeleteCart(@RequestBody List<Long> skuIdList) {
        Long userId = AuthContextHolder.getUserId();
