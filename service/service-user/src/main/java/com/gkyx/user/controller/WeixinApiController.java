package com.gkyx.user.controller;
...
import com.gkyx.enums.UserType;
import com.gkyx.enums.user.User;
import com.gkyx.user.service.UserService;
import com.gkyx.user.utils.ConstantPropertiesUtil;
import com.gkyx.user.utils.HttpClientUtils;
...
public class WeixinApiController {
    ...
    public Result loginWx(@PathVariable String code) {
        ...
        try {
            ...
            throw new GkyxException(ResultCodeEnum.FETCH_ACCESS_TOKEN_FAILD);
        }
